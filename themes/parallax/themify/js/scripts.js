...
jQuery(document).ready(function($){
     ...
     */
    $('.themify_field').find('.query_category').blur(function(e){
        $(this).parent().find('.val').val($(this).val());
    }).keyup(function(){
    	$(this).parent().find('.val').val($(this).val());
    });

	$('.themify_field').find('.query_category_single').change(function() {
    ...
    $('.themify-info-link').closest('.themify_field_row').addClass('query-field-visible');
	...
	$('.themify-info-link').closest('.themify_field_row').removeClass('query-field-hide');
